...
//     la EPS. Ambos tramos al 66.67% del valor día (auxilio legal de incapacidad EG).
...
export const PCT_EG_INCAP = 0.6667 // % del valor día reconocido en EG (empresa y EPS).
