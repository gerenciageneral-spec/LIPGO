...
export const configModules: Record<string, ModuleDefinition> = {
  ...
  // --- Tarifas (4 tablas), CRUD por pestañas en el submódulo Financiera > Tarifas ---
  tarifas_operacion: {
    id: "tarifas_operacion",
    name: "Tarifas de Operación",
    title: "Tarifas de Operación",
    icon: CreditCard,
    tableName: "tarifasoperacion",
    primaryKey: "id",
    orderBy: { column: "id", ascending: true },
    searchField: "operacion",
    fields: [
      { name: "id", label: "ID", type: "number", hidden: true, editable: false },
      ...
      { name: "empresafactura", label: "Empresa que factura", type: "text" },
      { name: "fechainicio", label: "Vigencia desde", type: "date" },
      { name: "fechafin", label: "Vigencia hasta", type: "date" },
      { name: "empresaid", label: "Empresa", type: "select", optionsUrl: "/api/owners", showInForm: false, showInTable: false },
    ],
  },
  tarifas_personal: {
    id: "tarifas_personal",
    name: "Tarifas de Personal",
    title: "Tarifas de Personal",
    icon: CreditCard,
    tableName: "tarifaspersonal",
    primaryKey: "id",
    orderBy: { column: "id", ascending: true },
    searchField: "operacion",
    fields: [
      { name: "id", label: "ID", type: "number", hidden: true, editable: false },
      { name: "operacion", label: "Operación", type: "text", required: true },
      { name: "tarifa", label: "Tarifa ($)", type: "number" },
      { name: "fechaini", label: "Vigencia desde", type: "date" },
      { name: "fechafin", label: "Vigencia hasta", type: "date" },
      { name: "empresaid", label: "Empresa", type: "select", optionsUrl: "/api/owners", showInForm: false, showInTable: false },
    ],
  },
  tarifas_turnos: {
    id: "tarifas_turnos",
    name: "Tarifas de Turnos",
    title: "Tarifas de Turnos",
    icon: CreditCard,
    tableName: "tarifasturnos",
    primaryKey: "id",
    orderBy: { column: "id", ascending: true },
    searchField: "puesto",
    fields: [
      ...
      { name: "horaentrada", label: "Hora de entrada", type: "text" },
      { name: "fechaini", label: "Vigencia desde", type: "date" },
      { name: "fechafin", label: "Vigencia hasta", type: "date" },
      { name: "base", label: "Base ($)", type: "number" },
      { name: "hed", label: "H.E. Diurna", type: "number" },
      { name: "hedf", label: "H.E. Diurna Festiva", type: "number" },
      { name: "hen", label: "H.E. Nocturna", type: "number" },
      { name: "hef", label: "H.E. Festiva", type: "number" },
      { name: "hn", label: "Recargo Nocturno", type: "number" },
      { name: "aplicaton", label: "Aplica por tonelada", type: "boolean", defaultValue: false },
      { name: "especialidad", label: "Especialidad", type: "boolean", defaultValue: false },
      { name: "idempresa", label: "Empresa", type: "select", optionsUrl: "/api/owners", showInForm: false, showInTable: false },
    ],
  },
  tarifas_facturacion_turnos: {
    id: "tarifas_facturacion_turnos",
    name: "Tarifas de Facturación por Turnos",
    title: "Tarifas de Facturación por Turnos",
    icon: CreditCard,
    tableName: "tarifasfacturacionturnos",
    primaryKey: "id",
    orderBy: { column: "id", ascending: true },
    searchField: "puesto",
    fields: [
      { name: "id", label: "ID", type: "number", hidden: true, editable: false },
      { name: "puesto", label: "Puesto", type: "text", required: true },
      { name: "cobraturno", label: "¿Cobra turno?", type: "select", options: [{ label: "SI", value: "SI" }, { label: "NO", value: "NO" }] },
      { name: "fechainicio", label: "Vigencia desde", type: "date" },
      { name: "fechafin", label: "Vigencia hasta", type: "date" },
      { name: "tarifaturno", label: "Tarifa turno", type: "number" },
      { name: "tarifaturnofestivo", label: "Tarifa turno festivo", type: "number" },
      { name: "tarifahoraextra", label: "Tarifa hora extra", type: "number" },
      { name: "costoturno", label: "Costo turno", type: "number" },
      { name: "costoturnofestivo", label: "Costo turno festivo", type: "number" },
      { name: "costohoraextra", label: "Costo hora extra", type: "number" },
    ],
  },
  accesos_usuario: {
    id: "accesos_usuario",
